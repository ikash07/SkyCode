...
export const explorer = asyncHandler(async (req: Request, res: Response) => {
  const tree = await listTree(req.params.projectId, req.auth!.sub);
  res.json({ tree });
});

export const fileRead = asyncHandler(async (req: Request, res: Response) => {
...
export const fileWrite = asyncHandler(async (req: Request, res: Response) => {
  const filePath = req.params.filePath || req.params[0] || '';
...
export const folderCreate = asyncHandler(async (req: Request, res: Response) => {
...
export const itemRename = asyncHandler(async (req: Request, res: Response) => {
...
export const itemDelete = asyncHandler(async (req: Request, res: Response) => {
  const filePath = req.params.filePath || req.params[0] || '';
